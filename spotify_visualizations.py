...
x_positions = [1, 2, 3, 4,]
chart_labels = ["3Q2018","4Q2018","1Q2019","2Q2019"]
earnings_actual =[0.26, 2.6,-0.89,-0.46]
earnings_estimate = [-0.42, -0.21,-0.40,-0.35]
...
revenue_by_quarter = [1.27, 1.35, 1.5, 1.51, 1.67]
earnings_by_quarter = [-0.394, 0.043, 0.442, -0.142, -0.076]
quarter_labels =["2Q-2018","3Q-2018","4Q-2018","1Q-2019","2Q-2019"]
...
# The Q3 and Q4 in 2018 was the only quarters without a loss. Let us calculate what percentage of the revenue constitutes the earnings:

# In[90]:


Q3_percent_earning =  0.043 / 1.35 * 100
print(Q3_percent_earning)

Q4_percent_earning = 0.442 / 1.5 * 100
print(Q4_percent_earning)
